...
class RecycleGANModel(BaseModel):
    ...
    def backward_D_A(self):
        ...
        self.loss_D_A = loss_D_A0.item() + loss_D_A1.item() + \
            loss_D_A2.item() + loss_D_A3.item()
    ...
    def backward_D_B(self):
        ...
        self.loss_D_B = loss_D_B0.item() + loss_D_B1.item() + \
            loss_D_B2.item() + loss_D_B3.item()
    ...
    def backward_G(self):
        ...
        self.loss_G_A = loss_G_A0.item() + \
            loss_G_A1.item() + loss_G_A2.item()
        self.loss_G_B = loss_G_B0.item() + \
            loss_G_B1.item() + loss_G_B2.item()
